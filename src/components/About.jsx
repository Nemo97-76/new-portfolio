...
<Typography variant="body1" className="about-span" >
    i'm a motivated junior developer widthsolid foundivation in the MERN stack (MongoDB, Express.js,React.js Node.js). Eager to apply my skills in real-world projects, i'm activly seeking opportunities to gain hands-on experience ,contribute to innovative solutions, and grow as a professional in web development. 
...
<Typography sx={{marginLeft:"20px",fontWeight:"700",width:"80px",wordBreak:"break-all"}}>
    Birthday :
</Typography>
...
<Typography component="p" sx={{fontSize:"1rem",width:"120px",wordBreak:"break-all"}}>
...
<Typography variant="h4">
    <CountUp enableScrollSpy={true} scrollSpyOnce={true} end={43} duration={7} className="counter-number" />
</Typography>
...
<Typography variant="h4">
    <CountUp enableScrollSpy={true} scrollSpyOnce={true} end={35} duration={7} className="counter-number" />
</Typography>
<Typography variant="span" className="counter-span">
    Hours of support
    </Typography>
...
<div className="counter">
  <FolderSpecialRoundedIcon className="counter-icon"/>
    ...
    <Typography variant="h4">
    <CountUp enableScrollSpy={true} scrollSpyOnce={true} end={2} duration={7} className="counter-number" />
</Typography>
<Typography variant="span" className="counter-span">
    Years of Experience
    </Typography>
...
<Typography variant="h4">
    <CountUp enableScrollSpy={true} scrollSpyOnce={true} end={12} duration={7} className="counter-number" />
</Typography>
<Typography variant="span" className="counter-span">
    Hard Workers
    </Typography>
